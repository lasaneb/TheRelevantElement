...
from apps import home, data, headlines, wombo_art_using_helium_driver #wombo_art_using_helium_driver # import your app modules here
...
relevant_element.add_app("Wombo Tool", wombo_art_using_helium_driver.app)
